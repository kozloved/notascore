"""Tests for Railway / Compose Redis URL selection."""

from redis_config import redis_url


def test_redis_url_prefers_private(monkeypatch):
    monkeypatch.setenv("REDIS_PRIVATE_URL", "redis://redis.railway.internal:6379")
    monkeypatch.setenv("REDIS_URL", "redis://default:public@host:6379")
    assert redis_url() == "redis://redis.railway.internal:6379"
